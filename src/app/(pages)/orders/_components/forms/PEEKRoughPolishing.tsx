...
export default function PeekPolishPage() {
	...
	const handleSubmit = async () => {
		console.log("Submitting PeekPolish:", { userName, dateTime });
	...
	return (
		<Card title="PeekPolish Process" style={{ textAlign: "center" }}>
			...
			{current === 0 && (
				<div style={{ marginTop: 20 }}>
					{/* <Title level={3}>PeekPolish</Title> */}
			...
			{current === 2 && (
				<div style={{ marginTop: 20 }}>
					{isSuccess ? (
						<Result status="success" title="PeekPolish Confirmed Successfully" />
					) : (
						<Result status="error" title="PeekPolish Submission Failed" subTitle="Please try again." />
					)}
				</div>
			)}
		</Card>
