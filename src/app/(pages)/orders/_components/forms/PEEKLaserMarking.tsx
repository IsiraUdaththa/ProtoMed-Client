...
export default function PEEKLaserMarkingProcess() {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center"}}>
      <Card title="PEEK Laser Marking Process" style={{ textAlign: "center", maxWidth: "600px", width: "100%" }}>
        ...
        {current === 2 && (
          <div style={{ marginTop: 20 }}>
            {isSuccess ? (
              ...
              <Result status="error" title="PEEK Laser Marking Process Submission Failed" subTitle="Please try again." />
            )}
          </div>
        )}
      </Card>
