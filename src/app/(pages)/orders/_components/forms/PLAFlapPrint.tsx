            ...
            <Card title="PLA Flap Print Process" style={{ textAlign: "left", maxWidth: 600, margin: "auto" }}>
              ...
              {current === 0 && (
                <div style={{ marginTop: 20 }}>
                  ...
                  <Input placeholder="Color" onChange={(e) => setFormData({ ...formData, color: e.target.value })} style={{ marginBottom: 10 }} />
                  <Input placeholder="Weight" onChange={(e) => setFormData({ ...formData, weight: e.target.value })} style={{ marginBottom: 10 }} />
                  <Select placeholder="Select Print Machine" onChange={(value) => setFormData({ ...formData, printMachine: value })} style={{ width: "100%", marginBottom: 10 }}>
              ...
              {current === 1 && (
                <div style={{ marginTop: 20 }}>
                  ...
                  <Text><strong>Color:</strong> {formData.color}</Text><br />
                  <Text><strong>Weight:</strong> {formData.weight}</Text><br />
                  <Text><strong>Print Machine:</strong> {formData.printMachine}</Text><br />
                  <Text><strong>Print Time:</strong> {formData.printTime}</Text>
                  <div style={{ marginTop: 20 }}>
                    <Button onClick={prev} style={{ marginRight: 10 }}>Back</Button>
